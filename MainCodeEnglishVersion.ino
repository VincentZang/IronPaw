...
const char* deepseekApiKey = "Enter your Deepseek API Key";
const char* baiduApiKey = "Enter your Baidu API Key";
const char* baiduSecretKey = "Enter your Baidu Secret Key";
...
// 硬件引脚配置
const int wakeButtonPin = 0;     // Wakeup Pin
...
const int recordDuration = 3000;   // 3 seconds recording
...
void maintainStorage() {
  const float CLEAN_THRESHOLD = 50.0;
